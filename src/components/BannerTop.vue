...
<div class="wave">
    ...
    <div class="row align-items-center">
        ...
        <div class="row">
            ...
            <img src="src/assets/img/phone_1.png" alt="Image" class="phone-1" data-aos="fade-right">
            <img src="src/assets/img/phone_2.png" alt="Image" class="phone-2" data-aos="fade-right" data-aos-delay="200">
            </div>
        </div>
        </div>
    </div>
